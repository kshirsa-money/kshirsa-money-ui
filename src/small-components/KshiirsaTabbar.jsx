    ...
    return (
        ...
        >
            <View style={KshirsaTabbarStyles.container} onLayout={onTabbarLayout}>
                {visibleFloatingBtn && (
                    <KshirsaFloatingBtn router={router} />
                )}
                    ...
                    return (
                        ...
                        >
                            <Animated.View style={[animatedIconStyle]}>
                                {icon[route.name] &&
                                    icon[route.name][isFocused ? 'focused' : 'unfocused']({
                                        focused: isFocused,
...
const KshirsaTabbarStyles = StyleSheet.create({
    gradientBorder: {
        ...
        right: 40,
        borderRadius: 50,
        padding: 2, // Creates space for the border effect
    },
    container: {
        backgroundColor: Colors.tabBarBg, // This should match your original background
        flexDirection: 'row',
        alignItems: 'center',
    ...
    floatingButton: {
        position: 'absolute',
        top: 10, // Adjust this value to position the button above the tab bar
        left: '50%',
